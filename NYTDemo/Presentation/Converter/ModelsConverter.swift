...
class ModelsConverter {
    ...
    internal func convertMediaDomainToPresentationModel(media: Media) -> MediaModel {
    ...
    /// - Parameter networkModel: network model
    /// - Returns: domain model.
    internal func convertMediaNetworkToDomainModel(media: NetworkMedia) -> Media {
    ...
    /// - Parameter networkModel: network model
    /// - Returns: domain model.
    internal func convertMediaDataNetworkToDomainModel(mediaData: NetworkMediaData) -> MediaData {
